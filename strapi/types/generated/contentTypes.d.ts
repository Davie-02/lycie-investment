...
export interface ApiHireVehicleHireVehicle extends Struct.CollectionTypeSchema {
  collectionName: 'hire_vehicles_v1';
  info: {
    displayName: 'Hire Vehicle';
    pluralName: 'hire-vehicles';
    singularName: 'hire-vehicle';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    currency: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'ZMW'>;
    description: Schema.Attribute.Text;
    features: Schema.Attribute.JSON;
    galleryImage: Schema.Attribute.Media<undefined, true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vehicleImage: Schema.Attribute.Media;
  };
}
...
export interface ApiNoticeNotice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    noticeType: Schema.Attribute.Enumeration<['banner', 'popup']> &
...
export interface ApiSeoSettingsSeoSettings extends Struct.CollectionTypeSchema {
  collectionName: 'seo_settings';
  info: {
    displayName: 'SEO Settings';
    pluralName: 'seo-settingss';
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Lycie Investment'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteContentSiteContent extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutBody: Schema.Attribute.RichText & Schema.Attribute.Required;
    aboutHeadline: Schema.Attribute.String;
    ...
    contactOpenHours: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    servicesEachBody: Schema.Attribute.JSON & Schema.Attribute.Required;
    servicesEachIcon: Schema.Attribute.JSON & Schema.Attribute.Required;
    servicesEachTitle: Schema.Attribute.JSON & Schema.Attribute.Required;
    servicesIntro: Schema.Attribute.String;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  collectionName: 'testimonials_v1';
  info: {
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coDriver: Schema.Attribute.String;
    ...
    externalLinks: Schema.Attribute.JSON;
    ...
    yearFacsimile: Schema.Attribute.Boolean;
  };
}
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::hire-vehicle.hire-vehicle': ApiHireVehicleHireVehicle;
