...
const en = {
  ...
  "auth.staffNote": "Lycie Investments staff: sign in here with your work email.",
...
const ny: Record<StringKey, string> = {
  ...
  "auth.staffNote": "Ogwira ntchito ku Lycie Investments: lowani apa ndi imelo yanu ya kuntchito.",
